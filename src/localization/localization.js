...
Localization.localizedStringList = {
    en: {
        ...
        guideStepDeployLinkHref: "https://github.com/Azure-Samples/iot-devkit-web-simulator/blob/source/README.md",
        guideStepFillCSTitle: "Configure your DevKit",
        guideStepFillCSDetail: "Here are the configurations you need to tell your DevKit. One is the IoT Hub Device coonection string, and the other is the #hashtag you want for the tweets. Click the link below to learn how to fill in these.",
        guideStepFillCSLinkName: "How to configure your DevKit",
        guideStepFillCSLinkHref: "https://github.com/Azure-Samples/iot-devkit-web-simulator/blob/source/README.md",
        ...
        guideStepFillCSErrorLinkHref: "https://github.com/Azure-Samples/iot-devkit-web-simulator/blob/source/README.md",
